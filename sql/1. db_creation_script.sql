...
/*==============================================================*/
/* Index: WEARABLE_SESSION_FK                                   */
/*==============================================================*/
create  index WEARABLE_SESSION_FK on MONITORING_SESSION (
ID_WEARABLE
);
...
alter table MONITORING_SESSION
   add constraint FK_MONITORI_WEARABLE_SESSION_WEARABLE foreign key (ID_WEARABLE)
      references WEARABLE (ID_WEARABLE)
      on delete restrict on update restrict;
